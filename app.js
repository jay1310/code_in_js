// Q1 Given 2 strings, a and b, return the number of the positions
...
function sameSubstring(s1, s2) {
  ...
  for (let i = 0; i < length - 1; i++) {
    if (s1[i] == s2[i] && s1[i + 1] == s2[i + 1]) count++;
  }
  return count;
}
console.log(
  'Q1(method 1): ',
  sameSubstring('xxcaazz', 'xxbaaz'),
  sameSubstring('abc', 'abc'),
  sameSubstring('abc', 'axc')
);
...
//Q2 Given a string, return a version where all the "x" have been removed.
...
function pattern_271(arr) {
  if (arr.length > 2) {
    for (let i = 0; i < arr.length - 2; i++) {
      if (
        arr[i + 1] == arr[i] + 5 &&
        Math.abs(arr[i] - arr[i + 2] - arr[i + 2]) <= 2
      )
        return true;
    }
  }
...
console.log(
  'Q12: ',
  sum_except13([1, 2, 2, 1]),
  sum_except13([1, 1, 2]),
  sum_except13([1, 2, 2, 1, 13, 7]),
  sum_except13([1, 5, 2, 1, 13])
);
...
console.log(
  'Q13: ',
  sum_except_6_to_7([1, 2, 2]),
  sum_except_6_to_7([1, 2, 2, 6, 99, 99, 7]),
  sum_except_6_to_7([1, 1, 6, 7, 2])
);
...
function sum28(arr) {
  var sum_2 = 0;
  arr.forEach((element) => {
    if (sum_2 > 8) return false;
    if (element == 2) sum_2 += element;
  });
  if (sum_2 == 8) return true;
  else return false;
}
console.log(
  'Q16: ',
...
function stringArray(n) {
  ...
  for (let i = 0; i < n; i++) arr[i] = i.toString();
...
function no_1_4(arr) {
  ...
  var present_1 = false;
  for (let i = 0; i < arr.length; i++) {
    if (arr[i] == 1) present_1 = true;
    if (arr[i] == 4) present_4 = true;
  }
  if (!present_1 || !present_4) return true;
  else return false;
}
console.log(
  'Q21: ',
...
function adjacent4(arr) {
  for (let i = 0; i < arr.length - 1; i++) {
    if (arr[i] == 4 && arr[i + 1] == 4) return true;
  }
  return false;
}

function either_adjacent_24(arr) {
  if ((adjacent2(arr) || adjacent4(arr)) && !(adjacent2(arr) && adjacent4(arr)))
    //adjacent2(arr) function is already defined in question 14.
    return true;
  else return false;
}
console.log(
  'Q23: ',
  either_adjacent_24([1, 2, 2]),
  either_adjacent_24([4, 4, 1]),
  either_adjacent_24([4, 4, 1, 2, 2])
);
...
function matchUp(arr1, arr2) {
  ...
  for (let i = 0; i < arr1.length; i++) {
    if (arr1[i] != arr2[i] && Math.abs(arr1[i] - arr2[i]) <= 2) count++;
  }
  return count;
}
console.log(
...
function has77(arr) {
  for (let i = 0; i < arr.length - 2; i++) {
    if (arr[i] == 7) {
      if (arr[i + 1] == 7 || arr[i + 2] == 7) return true;
    }
  }
  if (arr[arr.length - 2] == 7 && arr[arr.length - 1] == 7) return true;
  else return false;
}
console.log(
  'Q25: ',
